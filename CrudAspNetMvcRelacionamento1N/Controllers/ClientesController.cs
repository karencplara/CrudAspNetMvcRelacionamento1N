...
using CrudAspNetMvcRelacionamento1N.Models;

namespace CrudAspNetMvcRelacionamento1N.Controllers
{
    public class ClientesController : Controller
    {
        ...
        {
            var clientes = db.Clientes.Include(c => c.Consultor); //Eager Load(faz innerjoin nas duas tabelas, por isso Lazy Load não é recomendado.)
